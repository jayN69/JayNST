...
metadata {
    definition (name: "Zigbee Switch Power (Patched)", namespace: "jayn", author: "SmartThings/jayn", ocfDeviceType: "oic.d.smartplug", mnmn: "SmartThings",  vid: "generic-switch-power-energy") {
